...
class BaseBroad(Node):
    def __init__(self):
        ...
        self.base_direct = -1
        self.theta_max = math.radians(45)    #  pi/4
        self.theta_min = -math.radians(45)   # -pi/4
    ...
    def broad_tilted_ground(self):       # world -> tilted ground (broadcaster)
        ...
        q = quaternion_from_euler(0, self.theta_tilted, 0)
    ...
    def draw_zmp_marker(self):
        ...
        circle_ac_local = np.cross(CoG_local, alpha)
