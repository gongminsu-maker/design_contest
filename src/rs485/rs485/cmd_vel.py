...
class MotorControllerNode(Node):
    ...
    def motor_control(self,msg):
        ...
        speed_int = int(rpm*10)                   # 계산된 rpm을 실제 프로토콜에 맞는 rpm으로 변환 ex(1300rpm을 명령하면 130rpm으로 돈다)
    ...
    def send_motor_command(self):
        ...
        #Right motor
        checksum_R = (~(self.motor_id + data_size + mode + self.direction + self.speed[0] + self.speed[1] + time_to_reach)) & 0xFF
